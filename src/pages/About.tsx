          ...
          <div className="grid md:grid-cols-3 gap-8 items-start mb-12">
            <div className="md:col-span-1">
              <div className="relative">
                <img 
                  src={profileImage} 
                  alt="Martin Keene - Digital Marketing Expert"
              ...
              <div className="text-center mt-6">
                ...
                <a 
                  href="https://www.linkedin.com/in/martinkeene/" 
                  target="_blank" 
            ...
            <div className="md:col-span-2">
              <div className="prose prose-lg max-w-none text-foreground">
                ...
                <p className="text-lg leading-relaxed mb-6">
                  For the last eight years, I've been laser-focused on eCommerce sales & marketing building automated systems that nurture customer relationships, drive conversions, and scale businesses with efficiency across the globe.
                </p>
