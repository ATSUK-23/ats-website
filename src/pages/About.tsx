            ...
            <div className="md:col-span-2 mt-8 md:mt-0">
              <div className="prose prose-sm sm:prose-lg max-w-none text-foreground">
                ...
                <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 text-base sm:text-lg">
                  ...
                  <li><strong>Online Education:</strong> I've helped clients launch and scale digital membership programs, including one that grew from 0 to 16,000 students and generated $70M+ in revenue in just 4 years.</li>
