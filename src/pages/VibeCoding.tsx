...
const VibeCoding = () => {
  ...
  return <div className="dark min-h-screen bg-background text-foreground">
      ...
      <main>
        {/* Hero */}
        <HeroSection title="From Idea to Prototype in Days, Not Months" subtitle="Build your website, widgets or apps faster with AI-powered Vibe Coding" ctaText="LIVE 1 Day Workshops" ctaLink="#vibe-coding-form" backgroundImage="/lovable-uploads/c4d72d9f-395b-418d-89c3-09bac2b64fe5.png" />
