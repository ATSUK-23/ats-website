...
export default function AISolutions() {
  ...
  return <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        {/* Hero Section */}
        <HeroSection title="UNLEASH THE AI BRAIN IN YOUR BUSINESS" subtitle="AI solutions that delight your customers, boost sales, increase efficiency, slash costs & maximise profits." ctaText="Book an Introduction Call" ctaLink="#contact" backgroundImage={aiBrainBackground} className="py-24 md:py-32" />
        ...
        <SplitSection id="ai-brain-power" title="Unlock the Power of Your Company's AI Brain" description={<p>
            ...
            </p>} image={aiKnowledgeComparison} imageAlt="AI knowledge comparison showing scattered documents vs organized AI system" />
        ...
        {/* AI Solutions Grid */}
        <SplitSection id="ai-solutions-grid" title="What AI Solutions Can We Create For You?" description={<div className="grid gap-4 sm:grid-cols-2">
            ...
            </div>} image={aiServicesGrid} imageAlt="Grid of AI automation services" />
        ...
        {/* Industries Section */}
        <SplitSection id="industries" title="Industries We Serve" description={<div>
