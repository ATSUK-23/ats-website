      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your inquiry has been successfully submitted. We're excited to help you automate and grow your business!
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Our team will review your inquiry and reach out</p>
              </div>
            </div>
            <div className="text-center space-y-3">
              <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto">
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                <h5 className="font-medium text-foreground">Automation Strategy</h5>
                <p className="text-sm text-muted-foreground">Receive your custom automation roadmap</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <p className="text-muted-foreground">
            In the meantime, explore our services and resources
          </p>
