...
const SocialContentLeadForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        await fetch('https://hooks.zapier.com/hooks/catch/5146490/uhqsrsx/', {
          ...
          body: JSON.stringify({
            ...
            comments: formData.comments,
            formTag: 'social-content',
            timestamp: new Date().toISOString(),
            source: 'Social Content Form'
          }),
        });
      } catch (zapierError) {
      ...
      toast({
        ...
        description: "We'll be in touch soon to discuss your social content needs.",
      });
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your application has been successfully submitted. We're excited to help you build your personal brand!
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receive your personal branding roadmap</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <section id="social-content-form" className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
          ...
          <Card className="bg-card/80 backdrop-blur-sm border border-primary/20 shadow-xl">
            <CardHeader className="text-center pb-8">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
                Let's create a content strategy that grows your influence and attracts opportunities. Get started with our done-for-you social content system.
              </p>
            </CardHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Tell us about your personal branding goals or any questions you have..."
                  ...
                  <div className="pt-6">
                    ...
                    >
                      {isSubmitting ? "Submitting..." : "Start Building My Brand"}
                    </Button>
                  </div>
                </form>
              </CardContent>
...
export default SocialContentLeadForm;
