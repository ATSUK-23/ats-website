...
const AILeadForm = ({ formTag, title, subtitle }: AILeadFormProps) => {
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Your application has been successfully submitted. We're excited to help you leverage AI in your business!
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Receive your AI implementation roadmap</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <section id="ai-form" className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Tell us about your AI needs or any questions you have..."
                  ...
                  <div className="pt-6">
                    ...
                    >
                      {isSubmitting ? "Submitting..." : "Get Started with AI"}
                    </Button>
                  </div>
                </form>
              </CardContent>
